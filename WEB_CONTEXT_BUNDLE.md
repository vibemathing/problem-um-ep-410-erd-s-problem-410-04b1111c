...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-410-erd-s-problem-410-04b1111c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-410"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-410-erd-s-problem-410-04b1111c-v1",
      "problem_contract_sha256": "29913fd0ced6ae8f97acf5ff00a35a0d92b67e187ad045e3a581937e426c9bc2",
      "problem_id": "problem:um-ep-410-erd-s-problem-410-04b1111c",
      "route_id": "route:um-ep-410-erd-s-problem-410-04b1111c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-410-erd-s-problem-410-04b1111c-source-fidelity-01",
      "graph_id": "graph:um-ep-410-erd-s-problem-410-04b1111c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-410-erd-s-problem-410-04b1111c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-410-erd-s-problem-410-04b1111c-root",
          "statement": {
          ...
          "statement_sha256": "7071c16a1142b0a8e0f0acee123bbe2e752798cd1bf6f8a057965f559483b528"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-410-erd-s-problem-410-04b1111c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-410-erd-s-problem-410-04b1111c-root",
      "route_id": "route:um-ep-410-erd-s-problem-410-04b1111c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-410-43e346ed908a",
        "url": "https://www.unsolvedmath.com/problems/EP-410"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
